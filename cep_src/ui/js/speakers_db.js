        ...
        delBtn.addEventListener("click", function (e) {
            ...
            uiConfirm("Удалить выбранного спикера из базы?", function (okConfirm) {
                ...
                ensureSpeakersDbLoaded(function (ok) {
                    if (!ok) return;
                    CPHostAPI.call("removeSpeakerFromDb", [sp.name || "", sp.job || ""], { module: "speakersDb", timeoutMs: 15000 }, function (out) {
                        var res = out.result || "";
                        if (out.ok && res === "OK") {
...
function ensureSpeakersDbLoaded(cb) {
    ...
    CPHostAPI.call("getSpeakersDbJson", [], { module: "speakersDb", timeoutMs: 15000 }, function (out) {
        if (!out.ok) {
