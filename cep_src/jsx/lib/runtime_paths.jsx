...
//
// NOTE:
// - Helpers are exported as globals for reuse across host modules.
// =====================================================

cpGetEnvVar = function (name) {
    try {
...
cpGetUserProfileDir = function () {
    var p = cpExpandEnvVars("%USERPROFILE%");
    if (p) return p;

    var hd = cpGetEnvVar("HOMEDRIVE");
    var hp = cpGetEnvVar("HOMEPATH");
