...
#ifndef CaptionPanelsUI_H
#define CaptionPanelsUI_H
...
class CaptionPanelsUI
{
public:
	explicit CaptionPanelsUI(SPBasicSuite* spbP, AEGP_PanelH panelH, 
							AEGP_PlatformViewRef platformWindowRef,
							AEGP_PanelFunctions1* outFunctionTable);

protected:
	void operator=(const CaptionPanelsUI&);
	CaptionPanelsUI(const CaptionPanelsUI&); // private, unimplemented
